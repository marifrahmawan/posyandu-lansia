					...
					<div class="col-xs-12">
						<div class="box">
							<div class="box-header">
								<h3 class="box-title">Edit Data Diagnosa : <?php echo $data_penyakit->nama_penyakit; ?></h3>
							...
							<div class="box-body">
								<form action="" method="post">
									<input hidden type="text" name="id" value="<?php echo $data_penyakit->kode_penyakit ?>">
									<div class="form-group col-md-3 col-md-offset-4 col-md-pull-4 <?php echo form_error('nama_penyakit') ? "has-error" : null ?>">
										...
										<div class="input-group">
											<input type="text" name="nama_penyakit" id="Namai Diagnosa" class="form-control" value="<?php echo $data_penyakit->nama_penyakit ?>" autocomplete="off">
									...
									<div class="form-group col-md-7 <?php echo form_error('anjuran') ? "has-error" : null ?>">
										...
										<textarea name="anjuran" id="Anjuran" class="form-control" rows="8" cols="80"><?php echo $data_penyakit->anjuran ?></textarea>
									...
									<div class="form-group col-md-7 <?php echo form_error('pantangan') ? "has-error" : null ?>">
										...
										<textarea name="pantangan" id="Pantangan" class="form-control" rows="8" cols="80"><?php echo $data_penyakit->pantangan ?></textarea>
